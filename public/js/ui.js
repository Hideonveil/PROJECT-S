...
export function brandMark(size = 32) {
  return `<img class="brand-mark" src="/assets/jiyuan-logo-v5.png" width="${size}" height="${size}" alt="“机”缘" aria-hidden="true" />`;
}
...
export function homeShell(state, content, active = "home") {
  ...
  return `<div class="product-shell">
    <aside class="product-rail ${productRailHeldOpen ? "is-staggered-open is-route-held" : ""}" data-staggered-rail>
      ...
      <a class="product-brand" href="#/hero" aria-label="“机”缘首页">${brandMark(54)}<strong>“机”缘</strong></a>
    ...
    <div class="product-surface">
      <header class="product-topbar">
        <span class="product-topbar-kicker"><i>“机”缘 /</i><b>${sectionLabel}</b></span>
        ${state.authenticated
